  ...
  return (
    <div>
      <div className="min-h-[70vh] flex flex-col items-center justify-center text-center space-y-4">
        <UploadBox />
        <h1 className="text-xl md:text-2xl font-semibold">Smart PDF Reader</h1>
        <p className="max-w-xl md:text-lg px-5 md:px-0">
          Upload any PDF, extract clean text with OCR, and instantly translate
          each page into your language — smart, fast.
          <span className="inline-flex items-center">
            <AudioLines className="h-4 w-4 mr-2 ml-2" /> AI-powered
          </span>{" "}
          reading.
        </p>

        {/* Double Border Button with Link */}
        <Link
          href="/pdf"
...
const UploadBox = () => {
  return (
    <div className="p-3 flex relative flex-col items-center bg-gray-50 justify-center border border-dashed border-gray-500">
      {/* Top-Left Corner */}
      ...
      <svg
        ...
        viewBox="0 0 5 5"
        fill="none"
        className="fill-gray-500 absolute top-[-3px] left-[-3px]"
      >
        <path d="M2 0H3V5H2V0Z" />
        <path d="M0 3V2H5V3H0Z" />
      </svg>
      ...
      <svg
        ...
        viewBox="0 0 5 5"
        fill="none"
        className="fill-gray-500 absolute right-[-3px] top-[-3px]"
      >
        <path d="M2 0H3V5H2V0Z" />
        <path d="M0 3V2H5V3H0Z" />
      </svg>
      ...
      <svg
        ...
        viewBox="0 0 5 5"
        fill="none"
        className="fill-gray-500 absolute bottom-[-3px] right-[-3px]"
      >
        <path d="M2 0H3V5H2V0Z" />
        <path d="M0 3V2H5V3H0Z" />
      </svg>
      ...
      <svg
        ...
        viewBox="0 0 5 5"
        fill="none"
        className="fill-gray-500 absolute bottom-[-3px] left-[-3px]"
      >
        <path d="M2 0H3V5H2V0Z" />
        <path d="M0 3V2H5V3H0Z" />
      </svg>
